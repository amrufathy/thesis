...
class GigaWordDataModule(LightningDataModule):
    ...
    def __init__(self, data_dir, batch_size, train_path, val_path, processed_data_dir, **kwargs):
        super().__init__()
    ...
    def tokenize_example(self, example: Dict):
        ...
        article_embeddings = self.tokenizer(example['source'], padding='max_length', truncation=True, max_length=50)
        summary_embeddings = self.tokenizer(example['target'], padding='max_length', truncation=True, max_length=50)
        ...
        return {'story_ids': article_embeddings['input_ids'],
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        self.tokenized_dataset.set_format(type='torch', columns=['story_ids', 'story_attn_msk', 'story_labels',
