...
class Expander(nn.Module):
    def __init__(self, tokenizer: BartTokenizerFast = None, *args, **kwargs):
        ...
        self.expander: BartForConditionalGeneration = BartForConditionalGeneration.from_pretrained('facebook/bart-base')
    ...
    def forward(self, dict_input: Dict) -> Dict:
        ...
        story_ids_shifted = shift_tokens_right(dict_input['story_ids'], self.tokenizer.pad_token_id,
        ...
        return {'loss': expansion_loss, 'logits': expansion_logits,
